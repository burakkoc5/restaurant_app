...
abstract class $TokenModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, DateTime expiryDate});
}
...
class _$TokenModelImpl implements _TokenModel {
  const _$TokenModelImpl({required this.token, required this.expiryDate});
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, token, expiryDate);
...
abstract class _TokenModel implements TokenModel {
  const factory _TokenModel(
      ...
      required final DateTime expiryDate}) = _$TokenModelImpl;
